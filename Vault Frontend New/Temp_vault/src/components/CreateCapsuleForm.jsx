            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  ...
                  type="button"
                  className={cn(
                    "w-full justify-start text-left font-normal h-12 bg-transparent border-2 border-gray-600 text-white hover:bg-white/10 transition-all duration-300",
                    !date && "text-gray-400",
                  )}
                >
              ...
              <PopoverContent className="w-auto p-0 border-2 border-gray-600 bg-background">
                <Calendar
                  mode="single"
                  selected={date}
                  onSelect={setDate}
