      ...
      <div className="relative container mx-auto px-4 py-20 z-10">
        <div className="text-center mb-16 relative">
          ...
          <p className="text-xl sm:text-2xl text-gray-300 max-w-3xl mx-auto mb-12 leading-relaxed">
            Lock your thoughts, memories, and wishes in a digital vault
          ...
          <div className="flex flex-wrap justify-center gap-6 mb-12">
            ...
            <div className="bg-white/5 backdrop-blur-lg px-8 py-4 rounded-2xl border border-white/10 shadow-xl relative group">
              ...
              <div className="flex items-center space-x-3 relative z-10">
                ...
                <span className="text-gray-200 font-semibold text-lg">
                  {unlockedCapsules.length} Unlocked Vault
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            ...
            >
              ...
              <span className="relative flex items-center group-hover:text-white transition-colors duration-300">
                ...
                View All Vaults ({capsules.length})
              </span>
            </Link>
          </div>
        </div>
        <div className="mt-20">
          <h2 className="text-4xl sm:text-5xl font-bold text-center mb-12 w-full">
            <span
              className="bg-clip-text text-transparent inline-block mx-auto px-1"
              style={{
                backgroundImage:
                  "linear-gradient(to right, #e2e8f0, #fff, #e2e8f0)",
                lineHeight: 1.3,
            ...
            {capsules.length > 0 ? (
              capsules.slice(0, 3).map((capsule, index) => {
                ...
                return (
                  ...
                  >
                    <div
                      className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-8 shadow-xl border border-white/10 hover:border-white/20 group-hover:-translate-y-4 transition-all duration-300 hover:shadow-3xl h-full translate-y-10 opacity-0 animate-[slideUp_0.5s_ease-out_forwards]"
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        <div className="flex items-center justify-between mb-4">
                          ...
                          >
                            {isUnlocked ? (
                              <Unlock className="h-4 w-4 text-emerald-400 group-hover:text-emerald-300 transition-colors duration-300" />
                            ) : (
                              <Lock className="h-4 w-4 text-amber-400 group-hover:text-amber-300 transition-colors duration-300" />
                            )}
                          </div>
                        </div>
                        ...
                        <div className="mb-6 p-4 rounded-lg bg-black/20 border border-white/10 min-h-[80px] flex items-center">
                          {isUnlocked && !capsule.message.startsWith("🔒") ? (
                            ...
                            <div className="flex items-center text-amber-400/80 text-sm italic w-full">
                              <Lock className="h-3 w-3 mr-2 flex-shrink-0" />
                              <span>Content locked until unlock date</span>
                            </div>
                          )}
                        </div>
                        ...
                        <div className="space-y-3">
                          ...
                          <div className="flex items-center text-xs text-gray-500 pt-2 border-t border-white/5">
              ...
              <div className="text-center py-16 max-w-md mx-auto w-full">
                ...
                <p className="text-gray-400">
                  Be the first to create a vault and preserve your
